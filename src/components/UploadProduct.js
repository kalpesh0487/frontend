    ...
    <div className='fixed bg-slate-200 bg-opacity-35 w-full h-full top-0 left-0 bottom-0 right-0 flex justify-center items-center'>
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
            ...
            <input 
                          ...
                          return(
                            <div className='relative group'>
                               <img 
                                ...
                                <div className='absolute bottom-0 right-0 p-0.5 bg-white hidden group-hover:block cursor-pointer'
              ...
              <textarea 
                className='h-28 py-2 bg-slate-100 resize-none p-1' 
              ...
              <button className='pb-4 pt-3 px-3 py-2 bg-red-600 text-white mb-10 hover:bg-red-700'> Upload Product </button>
            </form>
        </div>
